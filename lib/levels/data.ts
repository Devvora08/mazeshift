...
export const LEVELS: LevelConfig[] = [
  ...
  level(3, 1, "It's Changing", 3, 15, 19, {
    scramble: { enabled: true, minIntervalSec: 20, maxIntervalSec: 23, falseAlarmChance: 0, intensityRatio: 0.7 },
    monsters: [],
    utilities: [],
    inventoryCap: 0,
  }),
  level(4, 1, 'Faster', 3, 14, 18, {
    scramble: { enabled: true, minIntervalSec: 15, maxIntervalSec: 17, falseAlarmChance: 0, intensityRatio: 0.7 },
    monsters: [],
    utilities: [],
    inventoryCap: 0,
  }),
  level(5, 1, 'The First Mark', 3, 16, 20, {
    scramble: { enabled: true, minIntervalSec: 15, maxIntervalSec: 18, falseAlarmChance: 0, intensityRatio: 0.7 },
    monsters: [],
    utilities: ['phase'],
    inventoryCap: 2,
  }),
  level(6, 2, 'Sealed Routes', 3, 16, 20, {
    scramble: { enabled: true, minIntervalSec: 14, maxIntervalSec: 17, falseAlarmChance: 0, intensityRatio: 0.7 },
    monsters: [],
    utilities: ['phase'],
    inventoryCap: 2,
  }),
  ...
  level(9, 2, 'Hunted & Shifting', 4, 16, 20, {
    scramble: { enabled: true, minIntervalSec: 13, maxIntervalSec: 16, falseAlarmChance: 0, intensityRatio: 0.7 },
    monsters: ['hunter'],
    utilities: ['phase', 'destroy'],
    inventoryCap: 2,
  }),
  ...
  level(11, 3, 'Walls Lie', 4, 18, 22, {
    scramble: { enabled: true, minIntervalSec: 12, maxIntervalSec: 15, falseAlarmChance: 0, intensityRatio: 0.7 },
  ...
  level(13, 3, 'Scarcity', 5, 18, 22, {
    scramble: { enabled: true, minIntervalSec: 11, maxIntervalSec: 14, falseAlarmChance: 0, intensityRatio: 0.7 },
    monsters: ['hunter', 'wraith'],
    utilities: ['phase', 'destroy', 'scramble'],
    inventoryCap: 1,
  }),
  ...
  level(19, 4, 'Nothing Left to Spare', 6, 20, 25, {
    scramble: { enabled: true, minIntervalSec: 9, maxIntervalSec: 12, falseAlarmChance: 0, intensityRatio: 0.7 },
    monsters: ['wraith', 'stalker'],
    utilities: ['phase', 'destroy', 'scramble', 'dash', 'shield', 'trap'],
    inventoryCap: 1,
  }),
